...
CHECKS = {
  "round3-fixture-image-deck-validation": {
    "any": [
      [
        "hardcoded",
        "scoped",
      ...
      [
        "cannot deliver unvalidated",
        "skip validation is invalid",
        "must run validation",
        "not optional",
        "do not ship without validation",
        "cannot be delivered while skipping"
      ]
    ]
  }
}
