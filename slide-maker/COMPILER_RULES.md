...
| `styles/transitions.css` | 13 cinematic slide transitions (iris, wipe-right, wipe-up, morph-fade, zoom-in, zoom-out, flip-x, flip-y, cube, swing, blur, glide) — imported by `styles/index.css` |
