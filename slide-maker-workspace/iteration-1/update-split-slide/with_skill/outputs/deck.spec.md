...
- kind: default-content
- layout: default
- title: Transitions and visual effects
- body:
  - bullet: 12 built-in transitions — fade, slide-left, slide-up, iris, wipe-right, wipe-up, morph-fade, zoom-in, zoom-out, flip-x, flip-y, blur
  - bullet: v-motion for element-level animation
  - bullet: v-mark annotations — underline, circle, strike, highlight, box
  - bullet: Shiki Magic Move for animated code transforms

### Slide 9
- kind: default-content
- layout: default
- title: Data visualization and design guardrails
- body:
  - bullet: 8 Mermaid diagram types — flowcharts, sequence, mind maps, pie charts, timelines, git graphs, entity-relationship, state diagrams
  - bullet: All diagrams use explicit inline styling (no default black-box labels)
  - bullet: WCAG contrast checking, LLM-tell detection, CRAP audit, screenshot validation
