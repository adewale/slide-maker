...
# The toolkit: transitions & visual effects
...
<!-- First half of the original breadth slide, now focused on motion and visual tooling. The specificity is preserved: 12 transitions (not "many"), 5 v-mark annotation styles. Giving transitions and effects their own slide lets the audience absorb the motion vocabulary before moving to data and quality. -->

---
transition: slide-left
---

# The toolkit: data & design guardrails
...
<!-- Second half of the original breadth slide, now focused on data rendering and quality assurance. 8 Mermaid diagram types (not "various"), 4 guardrail mechanisms. Separating guardrails from effects reinforces that validation is a first-class concern, not an afterthought tucked into a dense grid. -->
